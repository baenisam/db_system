...
const ListUser = props => {
  ...
  const getProduts = () => {
    setLoading(true);
    axios({
      url: config.BASE_URL + `account/${en && en.id_entreprise}/load`,
      method: 'GET',
      headers: {
    ...
    return (
      <TouchableOpacity
        ...
        <View style={{alignItems: 'center'}}>
          {en.fonction == 'Super Admin' && <TouchableOpacity
            style={{
              padding: 10,
              borderRadius:5,
    ...
    <SafeAreaView
      ...
      <View
        ...
        <View
          ...
          <View>
            {en.fonction == 'Super Admin' &&
          <TouchableOpacity
            onPress={() => navigation.navigate(ROUTES.ADD_USER)}
